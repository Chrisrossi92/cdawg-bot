export const passiveReactions = [
  {
    ...
    responses: [
      ...
      "Palworld base management is just confident crisis response.",
    ],
  },
  {
    key: "catching-pals",
    ...
    responses: [
      ...
      "Nothing builds character like a Pal escaping on a 95% feeling throw.",
    ],
  },
  {
    key: "palworld-grind",
    ...
    responses: [
      ...
      "Every big plan in Palworld starts with somebody needing more rocks.",
    ],
  },
] as const;
