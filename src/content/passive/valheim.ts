export const passiveReactions = [
  {
    key: "weather",
    keywords: ["the forest is moving", "you are being hunted", "cold", "wet", "freezing"],
    responses: [
  ...
  {
    key: "corpse-run",
    keywords: ["corpse run", "got my stuff back", "died again", "death run", "tombstone"],
    responses: [
  ...
  {
    key: "building",
    keywords: ["building", "roof keeps collapsing", "need iron", "need wood", "base build"],
    responses: [
